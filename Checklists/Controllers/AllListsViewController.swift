...
extension AllListsViewController: ListDetailViewControllerDelegate {
    func listDetailViewControllerDidCancel(_: ListDetailViewController) {
        navigationController?.popViewController(animated: true)
    }

    func listDetailViewController(_: ListDetailViewController, didFinishAdding checklist: Checklist) {
    ...
    func listDetailViewController(_: ListDetailViewController, didFinishEditing checklist: Checklist) {
